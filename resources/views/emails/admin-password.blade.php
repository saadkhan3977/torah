...
<body
 ...
 border-top: 0; border-bottom: 0; padding-top: 16px; padding-bottom: 8px"
                                valign="top">
 ...
 padding-bottom: 9px; padding-left: 18px;'
                                                                valign="top">
                                                                <h2 style="font-weight: bold; color: white; font-size: 40px; text-align: center">Memory Palace</h2>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
 ...
 padding-bottom: 9px; padding-left: 18px;'
                                                                ...
                                                                <h1 class="null"
                                                                    style='color: #2a2a2a; font-family: "Asap", Helvetica,
 ...
 padding: 0'>
                                                                    <span
                                                                        style="text-transform:uppercase">Forgot</span>
                                                                </h1>
 ...
 padding: 0'>
                                                                    <span style="text-transform:uppercase">your
                                                                        password ?</span>
                                                                </h2>
 ...
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;'
                                                                valign="top">We cannot simply send you your old
                                                                password. A unique link to reset your
                                                                password has been generated for you. To reset your
                                                                password, click the
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;"
                                                                                valign="middle">
                                                                                <a class="mcnButton "
                                                                                    href="{{ route('admin.reset.get', $token) }}"
                                                                                    style="mso-line-height-rule: exactly;
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;"
                        ...
                        <tr>
                            <td id="templateFooter"
                                style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #fed149;
 border-top: 0; border-bottom: 0; padding-top: 8px; padding-bottom: 80px"
                                valign="top">
